#ifndef BHadron_JpsiTrkTrk_KinematicFitInterface_h
#define BHadron_JpsiTrkTrk_KinematicFitInterface_h
...
class KinematicFitInterface {
 ...
 public:
  ...
  double getProb() { return vtxprob_Bhadron; }
  RefCountedKinematicParticle getParticle() {return bhadron; }
  RefCountedKinematicVertex  getVertex()   { return bVertex; }
  RefCountedKinematicTree    getTree()     { return myTree_Bd; }
 ...
 private:
  ...
  RefCountedKinematicTree myTree_Bd;
